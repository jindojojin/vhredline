...
# Generated by qmake (2.01a) (Qt 4.4.0) on: Wed Aug 29 13:41:43 2018
# Project:  BlackLine.pro
# Template: app
# Command: c:\qt\4.4.0\bin\qmake.exe -spec c:\Qt\4.4.0\mkspecs\win32-g++ -win32 CONFIG+=release -o Makefile BlackLine.pro
#############################################################################
...
Makefile: BlackLine.pro  c:/Qt/4.4.0/mkspecs/win32-g++/qmake.conf c:/Qt/4.4.0/mkspecs/qconfig.pri \
		...
		c:/Qt/4.4.0/mkspecs/features/shared.prf \
	...
	$(QMAKE) -spec c:\Qt\4.4.0\mkspecs\win32-g++ -win32 CONFIG+=release -o Makefile BlackLine.pro
